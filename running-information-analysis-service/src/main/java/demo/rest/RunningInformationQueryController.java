...
public class RunningInformationQueryController {
    ...
    @RequestMapping(value = "/running/{healWarningLevel}", method = RequestMethod.GET)
    public Page<RunningInformation> findAllRunningInformationOrderByHealthWarningLevel(@PathVariable RunningInformation.HealWarningLevel healWarningLevel,
                                             @RequestParam(name = "page", required = false) int page,
                                             @RequestParam(name = "size", required = false) int size) {
        return this.runningInformationService.findAllRunningInformationOrderByHealWarningLevel(healWarningLevel, new PageRequest(page, size));
    }
